function MODULE:ResetCombatStatus(client)
...
function MODULE:EntityTakeDamage(target, dmg)
...
function MODULE:BeginWarmUp(entity)
...
function MODULE:AutoJoinCombat(ent)
    if lia.config.get("Turn Based Combat On/Off", true) then
...
function MODULE:PlayerTick(player, mv)
...
function MODULE:BeginCombat(tab)
