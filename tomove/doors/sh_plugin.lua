local MODULE = MODULE
MODULE.name = "Doors"
MODULE.author = "Leonheart#7476/Cheesenot & Leonheart#7476"
MODULE.desc = "A simple door system / Now has multifaction support!"
DOOR_OWNER = 3
DOOR_TENANT = 2
DOOR_GUEST = 1
DOOR_NONE = 0
...
do
    ...
    if SERVER then
        function entityMeta:keysOwn(client)
            ...
            MODULE:callOnDoorChildren(self, function(child)
                child:SetDTEntity(0, client)
            end)

            MODULE:UpdateClientDoorAccess(self, client, DOOR_OWNER)
        end
        ...
        function entityMeta:keysUnOwn(client)
            ...
            MODULE:UpdateClientDoorAccess(self, client, DOOR_NONE)
        end
        ...
        function entityMeta:addKeysDoorOwner(client)
            ...
            MODULE:UpdateClientDoorAccess(self, client, DOOR_TENANT)
        end
