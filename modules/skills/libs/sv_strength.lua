...
function MODULE:EntityTakeDamage(target, dmginfo)
    ...
    if IsValid(attacker) and attacker:IsPlayer() and IsValid(weapon) and table.HasValue(self.MeleeWeapons, weapon:GetClass()) then dmginfo:SetDamage(damage + strbonus) end
