...
function MODULE:HUDPaint()
    ...
    if CAMI.PlayerHasAccess(ply, "Lilia - Management - Development HUD", nil) then draw.SimpleText("| " .. ply:SteamID64() .. " | " .. ply:SteamID() .. " | " .. os.date("%m/%d/%Y | %X", os.time()) .. " | ", "DevHudText", w / 5.25, h / 1.12, Color(210, 210, 210, 255), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER) end
    if CAMI.PlayerHasAccess(ply, "Lilia - Management - Staff HUD", nil) then
