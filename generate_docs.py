...
GENERATOR_SUMMARIES = {
    ...
    'derma.md': 'Launches the visual editor for building Derma interfaces and generating Lilia-compatible GLua.',
 ...
 # Full paths for comprehensive index
    ...
    'generators/derma.md': 'Launches the visual editor for building Derma interfaces and generating Lilia-compatible GLua.',
