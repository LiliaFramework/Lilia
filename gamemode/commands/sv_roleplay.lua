lia.command.add(
    "roll",
    {
        ...
        onRun = function(client, arguments) lia.chat.send(client, "roll", math.random(0, math.min(tonumber(arguments[1]) or 100, 100))) end
    }
)
...
lia.command.add(
    "doorname",
    {
        ...
        onRun = function(client, arguments)
            ...
            if IsValid(tr.Entity) then print("I saw a " .. tr.Entity:GetName()) end
        end
    }
)
