...
--------------------------------------------------------------------------------------------------------
hook.Add("HUDShouldDraw", "HideHUD", function(element) if lia.config.HiddenHUDElements[element] then return false end end)
--------------------------------------------------------------------------------------------------------
...
hook.Add(
    ...
    function()
        ...
        if localPlayer.getLocalVar(localPlayer, "restricted") and not localPlayer.getLocalVar(localPlayer, "restrictNoMsg") then lia.util.drawText(L"restricted", scrW * 0.5, scrH * 0.33, nil, 1, 1, "liaBigFont") end
    end
)
