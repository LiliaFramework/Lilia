...
--------------------------------------------------------------------------------------------------------
hook.Add("ItemDraggedOutOfInventory", "ItemDraggedOutOfInventory", function(client, item) item:interact("drop", client) end)
--------------------------------------------------------------------------------------------------------
hook.Add(
    "HandleItemTransferRequest",
    "HandleItemTransferRequest",
    function(client, itemID, x, y, invID)
