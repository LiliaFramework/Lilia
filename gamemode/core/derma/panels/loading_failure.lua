...
function PANEL:Init()
    ...
    self.titleLabel = self.container:Add("liaText")
    ...
    self.messageLabel = self.container:Add("liaText")
    ...
    self.reasonLabel = self.container:Add("liaText")
    ...
    self.hintLabel = self.container:Add("liaText")
    ...
    self.retryButton = self.container:Add("liaButton")
...
function PANEL:UpdateErrorDisplay()
    ...
    if not IsValid(self.errorDisplayLabel) then
        self.errorDisplayLabel = self.container:Add("liaText")
...
vgui.Register("liaLoadingFailure", PANEL, "liaFrame")
