...
local logTypeData = {
    ...
    admin = {
        ...
        playerFlagGive = function(client, targetName, flags) return L("logPlayerFlagGive", client:Name(), targetName, flags) end,
        playerFlagGiveAll = function(client, targetName) return L("logPlayerFlagGiveAll", client:Name(), targetName) end,
        playerFlagTake = function(client, targetName, flags) return L("logPlayerFlagTake", client:Name(), targetName, flags) end,
        playerFlagTakeAll = function(client, targetName) return L("logPlayerFlagTakeAll", client:Name(), targetName) end,
