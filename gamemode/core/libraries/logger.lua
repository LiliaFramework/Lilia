...
local defaultlogs = {
    ...
    ["permissionDenied"] = {
        ...
        category = "@modulePermissionsName"
    },
    ["spawnDenied"] = {
    ...
    ["cheaterAction"] = {
        ...
        category = "@categoryCheaterActions"
    },
    ["altKicked"] = {
...
for logType, logData in pairs(defaultlogs) do
    lia.log.addType(logType, logData.func, logData.category)
end
