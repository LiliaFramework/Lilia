...
-- If just given a miliae, it is assumed miliaes.
function lia.util.getStringTime(text)
    local miliaes = tonumber(text)
    if miliaes then return math.abs(miliaes * 60) end
    local time = 0
