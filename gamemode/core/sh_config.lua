...
function lia.config.add(key, value, desc, callback, data, noNetworking, schemaOnly)
	...
	lia.config.stored[key] = {data = data, value = oldConfig and oldConfig.value or value, default = value, desc = desc, noNetworking = noNetworking, global = not schemaOnly, callback = callback}
end
