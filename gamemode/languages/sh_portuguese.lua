...
LANGUAGE = {
    ...
    cloud_no_module = "O module providenciado não é válido.",
    inv = "Inventário",
    modules = "Modules",
    author = "Autor",
    version = "Versão",
    ...
    contentTitle = "Conteúdo Lilia não encontrado",
    contentWarning = "Não tens o conteúdo do Lilia montado. Isto pode resultar em alguns recursos não funcionarem .\nO conteúdo do Lilia foi mudado para o do rebel1324.\nQueres abrir a pagina da loja para o conteúdo do Lilia?",
    flags = "Flags",
