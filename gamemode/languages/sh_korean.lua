...
LANGUAGE = {
    ...
    cloud_no_module = "클라우드 추가 기능이 존재하지 않습니다.",
    inv = "인벤토리",
    modules = "추가 기능",
    author = "제작자",
    version = "버전",
    ...
    consumables = "소모품",
    plyNotValid = "당신은 잘못된 플레이어를 보고 있습니다.",
    restricted = "당신은 저지되었습니다.",
    viewProfile = "스팀 프로필 보기",
    salary = "당신은 &s 만큼의 돈을 봉급으로 받았습니다.",
    ...
    contentTitle = "Lilia 콘텐츠 없음.",
    contentWarning = "당신은 Lilia 콘텐츠가 적용되어있지 않습니다. 특정 기능이 누락될 수 있습니다.\nLiliascipt 콘텐츠를 적용해야 합니다.",
    flags = "플래그",
    -- 2018 patch
    ammoLoadAll = "모두 사용",
