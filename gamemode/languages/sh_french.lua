...
LANGUAGE = {
    ...
    cloud_no_module = "Les Modules fournies ne sont pas valides.",
    inv = "Inventaire",
    modules = "Modules",
    author = "Auteur",
    version = "Version",
    ...
    contentWarning = "Vous n'avez pas monté le contenu Lilia. Cela peut entraîner l'absence de certaines fonctionnalités. L'adresse du contenu Lilia a été remplacée par celle de rebel1324.\nVoulez-vous ouvrir la page de l'atelier pour le contenu Lilia ?",
    flags = "Drapeaux",
