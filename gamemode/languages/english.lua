...
Reload: Drop]],
    ...
    selectWeaponToEdit = "Select a weapon to edit",
    weaponUpdated = "Weapon '%s' has been updated",
    weaponReset = "Weapon '%s' has been reset to default",
    allWeaponsReset = "All weapons have been reset to default",
    propertyReset = "Property '%s' has been reset",
    propertySaved = "Property '%s' has been saved",
    propertyModified = "Property '%s' has been modified",
    resetAll = "Reset All",
    saveAll = "Save All",
    swepEditorAutoSave = "SWEP Editor Auto-Save",
    swepEditorAutoSaveDesc = "Automatically save property changes when pressing Enter in the SWEP editor",
