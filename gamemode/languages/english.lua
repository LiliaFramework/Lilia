...
LANGUAGE = {
    ...
    moneyDropFailed = "Failed to drop money. Please try again.",
    ...
    banOOC = "Ban OOC",
    banOffline = "Ban Offline",
    banPlayer = "Ban Player",
    blindFadeAll = "Blind Fade All",
    blindFadePlayer = "Blind Fade Player",
    ...
    cloakPlayer = "Cloak Player",
    extinguishPlayer = "Extinguish Player",
    forceFallover = "Force Fallover",
    forceGetUp = "Force GetUp",
    freezePlayer = "Freeze Player",
    gagPlayer = "Gag Player",
    getCharacterInfo = "Get Character Info",
    godPlayer = "God Player",
    gotoPlayer = "Goto Player",
    ignitePlayer = "Ignite Player",
    jailPlayer = "Jail Player",
    kickCharacters = "Kick Characters",
    ...
    manageCharacterStats = "Manage Character Stats",
    ...
    returnPlayer = "Return Player",
    returnPlayers = "Return Players",
    setInventorySize = "Set Inventory Size",
    slayPlayer = "Slay Player",
    stripPlayer = "Strip Player",
    toggleCharacterLock = "Toggle Character Lock",
    toggleCheaterStatus = "Toggle Cheater Status",
    togglePermakill = "Toggle Permakill",
    toggleVoiceBanCharacter = "Toggle Voice Ban Character",
    unbanOOC = "Unban OOC",
    unbanOffline = "Unban Offline",
    unbanPlayer = "Unban Player",
    unblindPlayer = "Unblind Player",
    uncloakPlayer = "Uncloak Player",
    unfreezePlayer = "Unfreeze Player",
    ungagPlayer = "Ungag Player",
    ungodPlayer = "Ungod Player",
