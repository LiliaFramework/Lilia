...
Reload: Drop]],
    ...
    vendorNameUpdated = "Vendor name updated to '%s'.",
    vendorModelUpdated = "Vendor model updated successfully.",
    vendorSkinUpdated = "Vendor skin updated successfully.",
    vendorAnimationUpdated = "Vendor animation updated successfully.",
    vendorBodygroupUpdated = "Vendor bodygroup updated successfully.",
