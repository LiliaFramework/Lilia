...
Reload: Drop]],
    ...
    untying = "Untying...",
    youAreTied = "You are tied up!",
    isTied = "Tied",
    restricted = "RESTRICTED",
    staffRestrained = "%s attempted to restrain you while on duty!",
    cantRestrainStaff = "You cannot restrain staff members on duty!",
    alreadyCuffed = "This person is already restrained!",
    needAimPlayer = "You need to aim at a player!",
    cuffCannotChangeClass = "You cannot change class while restrained!",
}