...
LANGUAGE = {
    ...
    adminStickSetDoorGroupName = "Set Door Group",
    adminStickAddDoorGroupName = "Add Door Group",
    adminStickRemoveDoorGroupName = "Remove Door Group",
...
Reload: Drop]],
    ...
    staminaDrainDesc = "Rate at which stamina is drained when running or in vehicles.",
    ...
    staminaCrouchRegenerationDesc = "Rate at which stamina regenerates when crouching.",
    ...
    dooraddgroupDesc = "Add a group to a door's access list.",
    doorbuy = "Buy Door",
    doorData = "Door Data",
    doorEnableAll = "Enable All Doors",
    doorIDDesc = "Set the door ID for identification purposes.",
    doorremovegroupDesc = "Remove a group from a door's access list.",
    doorsetgroupDesc = "Set a group for a door's access control.",
