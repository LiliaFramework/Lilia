...
LANGUAGE = {
    ...
    enterDescriptionMinimum = "Please enter your description with a minimum of %d characters!",
    ...
    restrictedVehicle = "You can't spawn this vehicle since it's restricted!",
    ...
    adminStickWhitelistName = "Whitelist Player",
    ...
    characterNameLabel = "Character Name: %s",
    ...
    tryMaterialTool = "Try with Material Tool (may not work)",
...
Reload: Drop]],
    ...
    bannedAction = "You cannot do that while banned",
    welcomeServer = "Welcome to the server!",
    questReward = "You received %s for completing the quest.",
    doorLocked = "The door is locked.",
    chestTooClose = "Too close to another chest!",
    propRemoved = "Your prop was removed.",
    itemGlows = "Your item glows brightly.",
    itemMoved = "Item moved!",
    attribBoosted = "Boosted %s by %s",
    welcomeBack = "Welcome back! You last joined %s.",
    welcomeFirst = "Welcome for the first time!",
    serverTime = "Server time: ",
    currentRound = "Current round: %s",
    lastRoundWinner = "Last round won by %s",
    charReady = "Character ready",
    youSee = "You see %s",
    toolPermitted = "Tool is permitted!",
    toolBlocked = "Tool usage blocked.",
    welcomeDuty = "Welcome back to duty!",
    welcomeTutorial = "Welcome! Follow the arrows to begin the tutorial.",
    salaryReceived = "You have received your salary of $%s",
    optionsLoaded = "LOADED OPTIONS!",
    youStoodUp = "You stood up",
    welcomePlayer = "Welcome, %s",
    ticketClaimed = "Claimed ticket from %s",
    usedItem = "Used!",
    pickedUpItem = "Picked up: %s",
    itemUnequipped = "Item unequipped",
    nearPlayer = "Someone is close to you!",
    debugCanRecog = "%s canRecog: %s",
    debugPromptName = "%s promptName called",
    debugEnteredFakeName = "%s entered fake name: %s",
    debugUsingRealName = "%s using real name",
    debugCharRecognize = "%s CharRecognize called with level %s and name %s",
    debugTargetsFound = "%s found %s targets to recognize",
    debugRecognized = "%s recognized %s",
    debugFailedRecognize = "%s failed to recognize %s",
    debugRecognitionComplete = "%s recognition complete, total successes: %s",
    debugDoRange = "%s doRange called with level %s",
    debugDoRangeCallback = "%s doRange callback with name %s",
    debugActionWhisper = "%s action recognizeInWhisperRange triggered",
    debugActionTalk = "%s action recognizeInTalkRange triggered",
    debugActionYell = "%s action recognizeInYellRange triggered",
    debugInteractionTriggered = "%s interaction recognizeOption triggered on %s",
    debugInteractionCallback = "%s interaction callback with name %s",
    debugInteractionSuccess = "%s interaction recognition succeeded on %s",
    debugInteractionFail = "%s interaction recognition failed on %s",
    targetClass = "Class: %s",
