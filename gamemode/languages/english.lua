...
Reload: Drop]],
    ...
    gavePlayerFlags = "gave player flags",
    tookPlayerFlags = "took player flags",
    ...
    vendorWarningSkippingInvalidItem = "[Vendor] Warning: Skipping invalid item",
    liaTable = "[liaTable]",
