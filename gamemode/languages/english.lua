...
LANGUAGE = {
    ...
    doorSaveData = "Door data has been saved: %s",
    ...
    recogBotsDesc = "Force all bots to recognize people around them.",
...
Reload: Drop]],
    ...
    workshopDownloadPrompt = "Would you like to download the content needed for the server? (%s/%s) (%s GB)",
