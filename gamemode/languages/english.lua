...
LANGUAGE = {
    ...
    adminStickSubCategoryFactionWhitelist = "Faction Whitelist",
    adminStickSubCategoryClassWhitelist = "Class Whitelist",
    adminStickSubCategoryFlags = "Flags",
    adminStickSubCategoryMiscellaneous = "Miscellaneous",
