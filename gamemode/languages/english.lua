...
LANGUAGE = {
    ...
    invalidGroup = "The specified faction group is not valid.",
    definefactiongroupDesc = "Define a new faction group by selecting factions from a list.",
    factionGroupExists = "Faction group '%s' already exists.",
    noFactionsAvailable = "No factions are available to add to groups.",
    selectFactionsForGroup = "Select Factions for Group: %s",
    selectFactionsDesc = "Choose which factions should be part of this group. You can select multiple factions.",
    noFactionsSelected = "No factions were selected for the group.",
    factionGroupCreated = "Faction group '%s' created successfully with %d factions.",
    factionGroupMembers = "Group members: %s",
    listfactiongroupsDesc = "List all defined faction groups and their members.",
    noFactionGroups = "No faction groups have been defined.",
    factionGroupsHeader = "Faction Groups (%d total):",
    factionGroupInfo = "%s (%d factions): %s",
    removefactiongroupDesc = "Remove an existing faction group.",
    factionGroupNotFound = "Faction group '%s' not found.",
    factionGroupRemoved = "Faction group '%s' has been removed.",
    submit = "Submit",
    ...
    doorSetGroup = "This door now belongs to the '%s' faction group.",
    doorAddGroup = "Added %d factions from the '%s' group to this door.",
    doorGroupEmpty = "The '%s' faction group contains no factions.",
    doorRemoveGroup = "This door no longer belongs to any faction group.",
    missingGroupName = "You must specify a faction group name.",
    ...
    wipeStoragesConsoleConfirm = "TO CONFIRM STORAGE WIPE, RUN 'lia_wipestorages' AGAIN in 3 SECONDS.",
    wipeStoragesConsoleProgress = "STORAGE WIPE IN PROGRESS.",
    wipeStoragesConsoleComplete = "SUCCESSFULLY WIPED %s STORAGE INVENTORIES CONTAINING %s ITEMS.",
    ...
    vendorSavePreset = "Save Vendor Preset",
    vendorPresetName = "Preset Name",
    vendorPresetNameDesc = "Enter a name for this vendor preset:",
    vendorPresetNameRequired = "Preset name cannot be empty.",
    vendorPresetOverwrite = "A preset with the name '%s' already exists. Overwrite it?",
    ...
    vendorNoPresets = "No vendor presets available.",
    vendorPresetList = "Available vendor presets: %s",
    ...
    doorsetgroupDesc = "Set a faction group restriction for a door, allowing only factions in that group to access it.",
    dooraddgroupDesc = "Add all factions from a group to the door's faction access list.",
    doorremovegroupDesc = "Remove the faction group restriction from a door.",
    ...
    adminStickAddDoorGroupName = "Add Door Group Factions",
...
Reload: Drop]],
    ...
    workshopAddedMultiple = "Added %d addons to download list",
    workshopDownloader = "Workshop Downloader",
    workshopAllInstalled = "All required workshop content is already installed.",
    workshopMountConfirm = "You are missing %d workshop addon(s) required by this server.\n\nDo you want to download and mount them?",
    workshopMounting = "Mounting workshop content...",
    workshopMountingAddon = "Mounting addon %s (%d/%d)...",
    workshopMountComplete = "Workshop content mounting completed!",
    workshopMountFailed = "Failed to mount addon %s",
    moduleSkipped = "Module Skipped",
    moduleDisabledTitle = "Module Disabled",
    modulesDisabledList = "The following modules are disabled: %s",
    module = "Module",
    compatibility = "Compatibility",
    database = "Database",
    moduleSkipMissing = "Skipping module '%s' - missing %s.lua",
    moduleLoadingSummary = "Loaded %s Modules and %s Submodules",
    ...
    copyEntityInfo = "Copy Entity Info",
    entityRemoved = "Entity removed: %s",
    ...
    vendors = "Vendors",
    animation = "Animation",
    vendorAnimationTooltip = "Select the animation sequence for the vendor to use when spawned",
    storage = "Storage",
    ...
    doorID = "Door ID: ",
    doorNoValidMapID = "This door doesn't have a valid map ID",
    doorMustBeLookingAt = "You must be looking at a door",
    doorNoDoorsFound = "No doors found on this map",
    doorFoundCount = "Found %s doors. Check your UI for details.",
    doorIDDesc = "Shows the door ID of the door you're looking at",
    listDoorIDsDesc = "Lists all door IDs on the map for preset creation",
    ...
    itemEntityInvalid = "Item entity is invalid",
    noclipWhileDead = "You cannot noclip while dead",
    plyGagged = "Player gagged",
    plyMuted = "Player muted",
    plyUngagged = "Player ungagged",
    plyUnmuted = "Player unmuted",
