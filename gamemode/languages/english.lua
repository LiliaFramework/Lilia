...
LANGUAGE = {
    ...
    forceRespawnHint = "If stuck, ask an admin to use /forcerespawn",
...
Reload: Drop]],
    ...
    factionViewNotActive = "Faction view is not currently active.",
    factionViewDisabled = "Faction view disabled. Returning to normal view.",
    factionViewUsingMap = "ViewAsFaction: Using map '%s' for faction '%s'",
