...
LANGUAGE = {
    ...
    noAdminStickOptions = "No admin stick options available for this target.",
...
Reload: Drop]],
    ...
    categoryStaffUsergroups = "Staff: Permissions",
    ...
    suppressIPInChat = "Suppress IPs in Chat",
    suppressIPInChatDesc = "Blocks messages containing IP addresses and punishes the sender.",
