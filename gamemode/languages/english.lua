...
LANGUAGE = {
    ...
    ["View Own Playtime"] = "View Own Playtime",
    ["View Playtime"] = "View Playtime",
    ["View Staff Management"] = "View Staff Management",
    ["Use Admin Stick"] = "Use Admin Stick",
...
Reload: Drop]],
    ...
    invalidItemDesc = "[[INVALID DESCRIPTION]]",
    ...
    moduleInteractionMenuName = "Interaction Menu",
    ...
    logDoorDisableAll = "%s disabled all doors (%d total).",
    logDoorEnableAll = "%s enabled all doors (%d total).",
    ...
    logVendorsRestockAll = "%s restocked all vendors (%d total)",
    logVendorMoneyReset = "%s set vendor %s money to %s",
    logVendorMoneyResetAll = "%s reset all vendors money to %s (%d affected)",
    ...
    logWarningIssued = "Warning issued at %s by admin '%s' to player '%s' for: '%s'. Total warnings: %d (added #%d).",
    logWarningRemoved = "Warning removed at %s by admin '%s' for player '%s'. Reason: '%s'. Remaining warnings: %d (removed #%d).",
    ...
    logAttribSet = "Admin '%s' set %s's '%s' attribute to %d.",
    logAttribAdd = "Admin '%s' added %d to %s's '%s' attribute.",
    logAttribCheck = "Admin '%s' viewed attributes of %s.",
    logInvUpdateSize = "Admin '%s' reset %s's inventory size to %dx%d.",
    logInvSetSize = "Admin '%s' set %s's inventory size to %dx%d.",
    ...
    logSpawnRemoveRadius = "Admin '%s' removed %d spawns within %d units.",
    logSpawnRemoveByName = "Admin '%s' removed %d spawns for faction '%s'.",
    ...
    logTicketClaimed = "Admin '%s' claimed a ticket for %s. Total claims: %d.",
    logTicketClosed = "Admin '%s' closed a ticket for %s. Total claims: %d.",
    logTeleportToEntity = "Admin '%s' teleported to entity '%s'.",
