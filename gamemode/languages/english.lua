...
LANGUAGE = {
    ...
    actionEnterVehicle = "Entering Vehicle...",
    ...
    rollDesc = "Roll a random number between 0 and 100.",
    ...
    flagGiveDesc = "Give one or more flags to a character.",
    flagGiveTitle = "Give Flags",
    flagGiveDescPrompt = "Enter the flags to give:",
    flagTakeDesc = "Take one or more flags away from a character.",
    flagTakeTitle = "Remove Flags",
    ...
    pmDesc = "Send a private message to another player (if PMs are enabled).",
