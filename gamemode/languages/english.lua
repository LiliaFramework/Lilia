...
LANGUAGE = {
    ...
    citizen = "Citizen",
    citizenDesc = "A regular member of society.",
    none = "None",
    ...
    hudFont = "HUD Font",
    hudFontDesc = "Font used for HUD-painted text and overlays.",
    fonts = "Fonts",
    custom = "Custom",
    disableSimfphysHUD = "Disable simfphys HUD",
    disableSimfphysHUDDesc = "Removes the simfphys HUD. This only applies after a Lua refresh or server restart.",
    simfphysHudRestartNotice = "The simfphys HUD setting will only apply after a Lua refresh or server restart.,",
    string = "String",
    ["continue"] = "Continue",
    invalidChar = "Invalid character.",
    charLoaded = "Character loaded: %s",
    unassigned = "Unassigned",
    search = "Search...",
    pressSpaceToContinue = "Press [SPACE] to continue",
    toggleExampleDesc = "Toggles the example feature.",
    usedFilteredWord = "Your message contained a filtered word and was not sent.",
    changelog = "Changelog",
    core = "Core",
    gameplay = "Gameplay",
    Lilia = "Lilia",
    remountWorkshopAddons = "Remount Workshop Addons",
    youHavePlayedFor = "You have played for ",
    createCharacterTooltipAvailable = "Create a new character (%s/%s slots used, %s remaining)",
    maximumCharactersReached = "Maximum characters reached (%s/%s)",
    loadExistingCharacter = "Load an existing character",
    loadMainCharacterTooltip = "Load your main character",
    loadStaffCharacterTooltip = "Load your staff character",
    createStaffCharacterTooltip = "Create a staff character",
    joinDiscordServer = "Join our Discord server",
    viewWorkshopCollection = "View our Workshop collection",
    mountRequiredWorkshopContent = "Mount required Workshop content",
    disconnectFromServer = "Disconnect from the server",
    dialog = "Dialog",
    history = "History",
    customizeNPC = "Customize NPC",
    npcNameLabel = "NPC Name:",
    modelPathLabel = "Model Path:",
    npcAnimationAuto = "Auto (idle animation)",
    refreshAnimationList = "Refresh Animation List",
    noAnimationsFoundForModel = "No animations found for this model.",
    tryRefreshAnimations = "Try Refresh Animations",
    dialogTypeLabel = "Dialog Type:",
    noneNoDialog = "None (No Dialog)",
    applyCustomizations = "Apply Customizations",
    otherConfigurations = "Other Configurations:",
    configuration = "Configuration",
    cancel = "Cancel",
    noWorkshopAddonsFound = "No workshop addons found. Make sure the server has configured workshop content.",
    selectNPCType = "Select NPC Type",
    weaponOverrideUpdated = "Successfully updated %s for %s",
    modelUpdatedOnRespawn = "Model updated. Will apply on respawn.",
    listedEntitiesWithinRadius = "Listed %s entities within %s units",
    removedPoint = "Successfully removed %s",
    pointNumber = "Point %s",
    points = "Points",
    removeThing = "Remove %s",
    pointDistanceInfo = "%s - Distance: %s units",
    noPointsFoundForType = "No points found for this type.",
    npcModelUpdated = "NPC model updated to: %s. Bodygroups and skin have been reset.",
    animationListRefreshed = "Animation list refreshed! Found %s animations.",
    animationsFoundReopenMenu = "Found %s animations! Please reopen the customization menu.",
    stillNoAnimationsFound = "Still no animations found. The model might not have animations.",
    noNPCTypesAvailable = "No NPC types available! The server may still be loading modules. Please try again in a moment.",
    noNPCConfigurationsAvailable = "No NPC configurations are available.",
    npcDialogTypeUpdated = "NPC dialog type updated successfully!",
    npcCustomizedSuccessfully = "NPC customized successfully!",
    previewMessagesSent = "Preview messages sent to your chat.",
    noManageNPCPermission = "You lack permission to manage NPCs.",
    mustLookAtValidEntity = "You must be looking at a valid entity.",
    mustLookAtDialogNPC = "You must be looking at a dialog NPC.",
    npcTypeChanged = "NPC type changed to: %s",
    configUpdatedSuccessfully = "Config '%s' updated successfully",
    attachmentEquipped = "Attachment equipped.",
    attachmentUnequipped = "Attachment unequipped.",
    attachmentUnequipFailed = "Failed to unequip attachment.",
    arccwAttachment = "ArcCW Attachment",
    arccwAttachmentDesc = "An attachment for ArcCW weapons.",
    arccwAttachmentFallbackDesc = "An attachment for ArcCW weapons.",
    attachments = "Attachments",
    copyBodygroups = "Copy Bodygroups",
    select = "Select",
    ...
    give = "Give",
    remove = "Remove",
    unequipThisItem = "Unequip this item",
    noAccess = "No Access",
    ...
    editBodygroupsDesc = "Open the bodygroup editor for a player's character.",
    manageBodygroups = "Manage Bodygroups",
    changeBodygroupsPrivilege = "Change Bodygroups",
    changeBodygroupsPrivilegeDesc = "Allows access to changing another player's bodygroups.",
    ...
    invalidBodygroup = "Invalid bodygroup selection. This often means the model isn't loaded in the server.",
    ...
    ticketDesc = "Sends a support ticket to staff.",
    unnamed = "Unnamed",
    ...
    youReceivedMoney = "You received %s.",
    ...
    itemGivenToSelf = "Item given to yourself successfully.",
    ...
    currencyNotificationImage = "Currency Notification Image",
    currencyNotificationImageDesc = "The material path for the currency icon used in money-type notifications",
    ...
    staffFactionCommandBlocked = "You cannot use targeted admin commands on players in the staff faction.",
    ...
    paydayReceived = "You received your payday: %s.",
    ...
    returnToCharacter = "Return to your character",
    ...
    spawnDeleted = "Sucessfully Removed Points",
    spawnAdded = "Sucessfully Added Point",
    ...
    allowedFactions = "Allowed Factions",
    ...
    doorFactionsCopied = "Copied %s faction restriction(s) from this door.",
    doorNoCopiedFactions = "You have no copied door faction restrictions to paste.",
    doorFactionsPasted = "Pasted %s faction restriction(s) onto this door.",
    ...
    doorClassesCopied = "Copied %s class restriction(s) from this door.",
    doorNoCopiedClasses = "You have no copied door class restrictions to paste.",
    doorClassesPasted = "Pasted %s class restriction(s) onto this door.",
    ...
    exampleEnabled = "Example Enabled",
    exampleEnabledDesc = "Whether the example feature is enabled.",
    exampleOption = "Example Option",
    exampleOptionDesc = "An example client option.",
    ...
    cannotSwitchWeaponPipboy = "You cannot switch weapons while the Pip-Boy is open.",
    ...
    flagBuildMenu = "Gives Access to the build menu.",
    ...
    classWhitelistRequired = "You must be whitelisted to join this class.",
    classRequirementsNotMet = "Not Available",
    ...
    oocBlockedDesc = "Whether or not out-of-character chat is globally blocked.",
    ...
    noBodygroupsnSkins = "No bodygroups or skins available for this model.",
    ...
    baseUsergroupCannotBeEditedDesc = "Base usergroups (user, admin, superadmin) cannot be edited. Please create a new usergroup instead using the 'Create Group' button.",
    baseUsergroupCannotBeEdited = "Base usergroups cannot be edited",
    samImmutableBaseGroupGrantIgnored = "[Lilia] Ignoring SAM request to grant privilege '%s' on immutable base usergroup '%s'. Change does not match default MinAccess behavior.",
    samImmutableBaseGroupRevokeIgnored = "[Lilia] Ignoring SAM request to revoke privilege '%s' on immutable base usergroup '%s'. Change does not match default MinAccess behavior.",
    searchWeapons = "Search Weapons...",
    weaponItemsConfig = "Weapon Items Config",
    weaponItemWidth = "Width",
    weapons = "Weapons",
    previewChatOutputs = "Preview chat outputs",
    logQuestComplete = "%s completed quest %s and received %s.",
    quests = "Quests",
    ...
    setExtraChars = "Set %s's extra characters to %d.",
    setExtraCharsOffline = "Set offline player %s's extra characters to %d.",
    ...
    changeModelAdmin = "%s changed %s's model to %s.",
    ...
    invalidSkin = "Invalid skin selection.",
    bodygroupChanged = "You changed %s bodygroups.",
    bodygroupChangedBy = "%s changed your bodygroups.",
    ...
    adminStickToggleDoorLockName = "Toggle Door State",
    buyDoor = "Buy Door",
    ...
    adminStickEditCharBodygroupsName = "Edit Character Bodygroups",
    ...
    removeWhitelist = "Remove Whititelist",
    ...
    seeInsertNotifications = "See Insert Notifications",
    ...
    textUnmuted = "%s has been unmuted for text chat.",
    textUnmutedByAdmin = "You have been unmuted for text chat by an admin.",
    textMuted = "%s has been muted for text chat.",
    textMutedByAdmin = "You have been muted for text chat by an admin.",
    mutedTryTalk = "You are muted and cannot talk in chat.",
    muted = "Muted",
    unmuted = "Unmuted",
    ...
    setClassDesc = "Sets the specified player's class.",
    ...
    npcChangeTypeTitle = "Change NPC Type",
    ...
    resetMapPropsDesc = "Restore all map-created props by performing a map cleanup.",
    resetMapPropsRunning = "Map cleanup started; map props will be restored shortly.",
    ...
    listNearbyEntitiesDesc = "Lists all entities within a specified radius around the player.",
    ...
    spawnDeletedByName = "Sucessfully Removed Points",
    ...
    storageContainerDesc = "A generic storage container.",
    ...
    workshopAddonDownloadFailed = "Failed to download workshop addon: %s",
    ...
    modulePreloadSuggestion = "Module '%s' is overridden by the schema. Place it in %s/preload for faster loading",
    ...
    alreadyInBaseFaction = "Character is already in the base faction.",
    ...
    drawPlayerHoverInfo = "Player Hover Info",
    drawPlayerHoverInfoDesc = "Show or hide hover information for players.",
    drawItemHoverInfo = "Item Hover Info",
    drawItemHoverInfoDesc = "Show or hide hover information for dropped items and money.",
    drawEntityHoverInfo = "Entity Hover Info",
    drawEntityHoverInfoDesc = "Show or hide hover information for general entities.",
    ...
    mainMenuUseLastPosDesc = "Uses the character's saved last position for the main menu camera when available, then falls back to the current position for the character you are already using.",
    ...
    drawDevelopmentHUDDesc = "Show or hide the developer and staff HUD overlay.",
    categoryChat = "Chat",
    ...
    liliaLegacySkinDesc = "The legacy skin for the Lilia framework.",
    ...
    invMaxWeight = "Max Inventory Weight",
    invMaxWeightDesc = "The maximum weight a player's inventory can hold.",
    invWeightUnit = "Inventory Weight Unit",
    invWeightUnitDesc = "The unit label displayed for inventory weight (e.g. KG, LB).",
    ...
    enablePainSound = "Enable Pain Sound",
    enablePainSoundDesc = "Enable or disable pain sounds globally.",
    fallDamageEnabled = "Enable Fall Damage",
    fallDamageEnabledDesc = "Enable or disable fall damage globally.",
    ...
    grabEarAnimationDesc = "Whether or not the grab ear animation is enabled.",
    mouthMoveAnimation = "Mouth Move Animation",
    mouthMoveAnimationDesc = "Whether or not the mouth movement animation is enabled.",
    ...
    voiceIconsDesc = "Whether or not the default voice icons are shown.",
    ...
    thirdPersonHeight = "Third Person Height",
    maxThirdPersonDistance = "Maximum Third-Person Distance",
    maxThirdPersonDistanceDesc = "Caps how far the third-person camera can be moved away from the character.",
    maxThirdPersonHorizontal = "Maximum Third-Person Horizontal Offset",
    maxThirdPersonHorizontalDesc = "Caps how far left or right the third-person camera can be offset from the character.",
    maxThirdPersonHeight = "Maximum Third-Person Height Offset",
    maxThirdPersonHeightDesc = "Caps how high the third-person camera can be offset above the character.",
    ...
    rotateInstruction = "Use %s and %s to rotate the model.",
    viewBodygroupsDesc = "View and edit a player's bodygroups.",
    bodyGrouperModel = "Bodygrouper Model",
    bodyGrouperModelDesc = "Model used for the bodygrouper entity.",
    ...
    staminaDrainDesc = "The rate at which stamina drains.",
    staminaRegeneration = "Stamina Regeneration",
    staminaRegenerationDesc = "The rate at which stamina regenerates.",
    staminaCrouchRegeneration = "Stamina Crouch Regeneration",
    staminaCrouchRegenerationDesc = "The rate at which stamina regenerates while crouching.",
    ...
    firstPersonEffects = "First Person Effects",
    firstPersonEffectsDesc = "Makes first-person movement add camera bob and sway.",
    firstPersonViewEffect = "First Person View Effect",
    firstPersonViewEffectDesc = "Makes the full-body first-person camera effect available when your weapon and view state allow it.",
    realisticViewEnabled = "Enable Realistic View",
    realisticViewEnabledDesc = "Makes realistic view work with non-whitelisted weapons instead of only the default keys behavior.",
    alwaysRealisticView = "Always Enable Realistic View",
    alwaysRealisticViewDesc = "Makes realistic view apply to non-whitelisted weapons. Right now it behaves the same as Enable Realistic View.",
    freelookEnabled = "Enable Freelook",
    freelookEnabledDesc = "Makes freelook available so you can look around without turning your character.",
    freelookLimitVertical = "Freelook Vertical Limit",
    freelookLimitVerticalDesc = "Makes freelook stop once you reach this up-or-down angle.",
    freelookLimitHorizontal = "Freelook Horizontal Limit",
    freelookLimitHorizontalDesc = "Makes freelook stop once you reach this left-or-right angle.",
    freelookSmoothness = "Freelook Smoothness",
    ...
    thirdPersonHeightDesc = "Makes the third-person camera sit higher or lower.",
    thirdPersonHorizontal = "Horizontal",
    thirdPersonHorizontalDesc = "Makes the third-person camera sit farther left or right.",
    thirdPersonDistance = "Distance",
    thirdPersonDistanceDesc = "Makes the third-person camera sit closer to or farther from your character.",
    ...
    logGiveMoneySteamID = "Gave %s to all %s characters owned by SteamID '%s'.",
    ...
    listDoorIDsDesc = "List every door on the current map with its map ID, position, and model.",
    ...
    deleteVendorPresetDesc = "Delete a saved vendor preset by name.",
    listVendorPresetsDesc = "List all saved vendor preset names.",
    ...
    invalidUsergroup = "Invalid usergroup: %s",
    invalidPlayer = "Invalid player: %s",
    ...
    loadMainCharacter = "Load Main Character",
    ...
    weightInv = "Simple Inventory",
    weightInvDescription = "Adds a weight-based simple inventory type with list display and storage support.",
    ...
    manageChatFilter = "Manage Chat Filter",
    chatFilterTitle = "Chat Filter",
    chatFilterWord = "Word",
    chatFilterSearch = "Search filtered words...",
    chatFilterAddWord = "Add Word",
    chatFilterRemoveWord = "Remove Selected",
    chatFilterEnterWord = "Enter the word you want to filter.",
    chatFilterWordAdded = "Added filtered word: %s",
    chatFilterWordRemoved = "Removed filtered word: %s",
    chatFilterWordExists = "That word is already filtered.",
    chatFilterWordMissing = "That word is not in the filter list.",
    chatFilterNoSelection = "Select a filtered word first.",
    chatFilterInvalidWord = "Enter a valid word first.",
    chatFilterEmpty = "No filtered words found.",
    chatFilterSummary = "Manage the blocked word list used by chat moderation. Add new entries, search existing ones, or remove outdated filters.",
    chatFilterTrackedWords = "Tracked words: %s",
    chatFilterWordLabel = "Filtered word",
    ...
    exampleDesc = "An example command.",
    ...
    distanceToolSetPoint = "Left Click: Set point",
    distanceToolClearPoints = "Right Click: Clear points",
    distanceToolMeasureCurrent = "Reload: Measure current",
    ...
    staffCharacterLabel = "Staff Character",
    setAsMainCharacter = "Set as Main Character",
    mainCharacterSet = "Character set as main character.",
    loadedMainCharacter = "Main character loaded.",
    noMainCharacter = "No main character set.",
    mainCharacterNotFound = "Main character not found.",
    mainCharacterCooldownDays = "Main Character Cooldown (Days)",
    mainCharacterCooldownDaysDesc = "How many days until you can change your main character again. Set to 0 to allow changes at any time.",
    ...
    pkReasonMenu = "PK Reason & Evidence",
    pkDeathOptionMenu = "PK Death Option",
    instantDeath = "Kill instantly (auto-ban)",
    ...
    vendorGeneralInfoSubtitle = "Edit the vendor's appearance, presets, stock, and access rules.",
    vendorItemsSubtitle = "Set trade mode, buy price, sell price, and stock.",
    vendorStockToggle = "Enable Stock",
    vendorFactionAccessSubtitle = "Choose which factions and classes can use this vendor.",
    vendorStockMaxShort = "Max",
    vendorStockCurrentShort = "Cur.",
    vendorSellPriceLabel = "Sell Price",
    vendorBuyPriceLabel = "Buy Price",
    vendorSavePresetTitle = "Save Vendor Preset",
    vendorSavePresetPrompt = "Enter a name for this preset:",
    vendorNameChanged = "Changed vendor name from %s to %s.",
    vendorDescriptionChanged = "Changed vendor description from %s to %s.",
    vendorModeChanged = "Changed mode for %s from %s to %s.",
    vendorBuyPriceChanged = "Changed buy price for %s from %s to %s.",
    vendorSellPriceChanged = "Changed sell price for %s from %s to %s.",
    vendorStockDisabledChanged = "Disabled stock for %s. Previous max stock was %s.",
    vendorStockMaxChanged = "Changed max stock for %s from %s to %s.",
    vendorStockCurrentChanged = "Changed current stock for %s from %s to %s.",
    vendorStockEnabledChanged = "Changed stock option from %s to %s.",
    vendorFactionChanged = "Set faction access for %s to %s.",
    vendorClassChanged = "Set class access for %s to %s.",
    vendorModelChanged = "Changed vendor model from %s to %s.",
    vendorSkinChanged = "Changed vendor skin from %s to %s.",
    vendorBodygroupChanged = "Changed vendor bodygroup %s from %s to %s.",
    vendorUseMoneyChanged = "Changed vendor money usage from %s to %s.",
    vendorMoneyChanged = "Changed vendor money from %s to %s.",
    vendorPresetChanged = "Changed vendor preset from %s to %s.",
    vendorAnimationChanged = "Changed vendor animation from %s to %s.",
    ...
    keybindReserved = "The key '%s' is reserved by the game and cannot be reassigned.",
    ...
    cannotDrop = "You cannot drop this item.",
    ...
    cannotPickupWhileWanted = "You cannot pick up items while wanted.",
    needMorePlaytime = "You need more playtime to perform this action.",
    noWhitelist = "You are not whitelisted for this.",
    ...
    totalPanelsOnScreen = "Total panels on screen (including subpanels): %d",
    visiblePanels = "Visible panels: %d",
    visiblePanelTypes = "Visible panel types:",
    hiddenPanels = "Hidden panels: %d",
    hiddenPanelTypes = "Hidden panel types:",
    ...
    failedToCreatePanel = "Failed to create: %s",
    ...
    noSavedSoundsFound = "No saved sounds found!",
    play = "Play",
    playingSound = "Playing: %s",
    failedToPlaySound = "Failed to play: %s (%s)",
    soundFileNotFound = "Sound file not found: %s",
    stoppedAllSounds = "Stopped all sounds",
    noSavedImagesFound = "No saved images found!",
    imageViewerTitle = "Image Viewer - %s",
    copyPath = "Copy Path",
    imagePathCopied = "Image path copied to clipboard: %s",
    directTestSuccessful = "Direct test successful: %s",
    directTestFailed = "Direct test failed: %s (%s)",
    noSoundFilesForTesting = "No sound files found for testing",
    ...
    skinPreviewListViewSelection = "List View Selection",
    role = "Role",
    sampleNameAlex = "Alex",
    sampleNameSam = "Sam",
    ...
    entitiesWithinRadiusHeader = "=== Entities within %s units ===",
    entityCategoryHeader = "--- %s (%s) ---",
    entityDistanceClassInfo = "%s units: %s",
    entityHealthLabel = "HP: %s",
    totalEntitiesFound = "Total entities found: %s",
    failedToCreateModelPanel = "Failed to create model panel",
    joinFactionTitle = "Join Faction",
    theEnvironment = "the environment",
    characterIDSteamID64 = "Character ID %s [STEAMID64 %s]",
    characterSteam64ID = "Character %s | Steam64ID %s",
    killedByAt = "You were killed by %s at %s",
    staffLogPlayerSteam64 = "%s (Steam64ID: %s)",
    staffLogPlayerJoined = "Player %s (Steam64ID: %s) has joined the server.",
    staffLogPlayerLeft = "Player %s (Steam64ID: %s) has left the server.",
    staffLogTicketClaimed = "%s claimed a ticket from %s",
    staffLogTeleportedToSitRoom = "%s (Steam64ID: %s) teleported to sit room \"%s\".",
    staffLogCheaterFlagged = "%s (Character %s | Steam64ID: %s) was flagged for cheating. Severity: %s.",
    staffLogDeathMessage = "%s (Character %s | Steam64ID: %s) was killed by %s",
    copyPosition = "Copy Position",
    copyAngles = "Copy Angles",
    copyPosAngPrintpos = "Copy Pos + Ang (printpos)",
    ...
    staffLogSetMoney = "%s set money of %s (Steam64ID: %s) to %s",
    staffLogGaveMoney = "%s gave %s to %s (Steam64ID: %s). New balance: %s",
    staffLogWarnedPlayer = "%s warned %s (Character %s | Steam64ID: %s) for \"%s\" [Severity: %s].",
    inventorySizeChangedSwapCharacters = "Your inventory size has been changed to %sx%s. Please swap characters for the change to take effect.",
    staffLogInventorySizeSet = "Inventory size set to %sx%s for %s (Steam64ID: %s).",
    noCharactersFoundForSteamID = "No characters found for SteamID: %s",
    gaveMoneyToCharacterOnline = "Gave %s to character '%s' (ID: %s). New balance: %s (player online)",
    successfullyGaveMoneyToCharacters = "Successfully gave %s to %s characters owned by SteamID: %s",
    gaveMoneyToCharacterOffline = "Gave %s to character '%s' (ID: %s). New balance: %s (player offline)",
    errorUpdatingMoneyForCharacter = "Error updating money for character '%s' (ID: %s)",
    databaseErrorValue = "Database error: %s",
    speedCommandDesc = "Check your current movement speeds.",
    speedCommandStatus = "Current speeds - Run: %d, Walk: %d",
    npcChangeTypePrompt = "Choose what type of NPC this should be:",
    factionSpawnAdderTitle = "Faction Spawn Adder",
    classSpawnAdderTitle = "Class Spawn Adder",
    sitRoomTitle = "Sit Room",
    copySteamNameFormat = "Steam Name: %s (copy)",
    copySteamProfileFormat = "Steam Profile: %s (copy)",
    copySteamID64Format = "SteamID64: %s (copy)",
    copyModelFormat = "Model: %s (copy)",
    copyPositionFormat = "Position: %s (copy)",
    adminHUDName = "Name: %s",
    adminHUDSteamName = "Steam Name: %s",
    adminHUDHealth = "Health: %s/%s",
    adminHUDWeapon = "Weapon: %s",
    adminHUDUserGroup = "User Group: %s",
    adminHUDSpeed = "Speed: %s",
    adminHUDEntityClass = "Class: %s",
    adminHUDOwner = "Owner: %s",
    adminHUDEntityID = "Entity ID: %s",
    adminStickInstructionSelectTarget = "Left Click: Selects target",
    adminStickInstructionFreezePlayer = "Right Click: Freezes player",
    adminStickInstructionSelectSelf = "Shift + R: Selects yourself",
    adminStickInstructionClearSelection = "R: Clears the selection",
    positionToolInstructionSetAim = "Left Click: Set position at aim",
    positionToolInstructionUseCurrentPosition = "Right Click: Use current position",
    positionToolInstructionCycleMode = "Shift + Reload: Cycle position type",
    positionToolInstructionOpenRemovalMenu = "Shift + E: Open removal menu",
    positionToolCurrentMode = "Mode: %s",
    adminStickInstructionSwitchMode = "Reload: Switch tool section",
    adminStickHUDMode = "Mode",
    adminStickHUDControls = "Controls",
    adminStickHUDLeftClick = "Left Click",
    adminStickHUDRightClick = "Right Click",
    adminStickHUDReload = "Reload",
    debugMode = "Debug Mode",
    administrativeMode = "Administrative Mode",
    worldConfigurationMode = "World Configuration",
    doorAccessDataLabel = "Access Data: %s",
    doorPartnerDoorLabel = "Partner Door: %s",
    doorIsLockedLabel = "Is Locked: %s",
    idPrefix = "ID: %s",
    severityLow = "Low",
    severityMedium = "Medium",
    severityHigh = "High",
    spawnForFactionFormat = "Spawn For Faction '%s'",
    spawnForClassFormat = "Spawn For Class '%s'",
    sitRoomLabelFormat = "Sit Room %s",
    distanceMeasureClickToSetStart = "Click to set start point",
    dialogNPCName = "Dialog NPC",
    sampleDoorName = "Sample Door %s",
    npcTypeNotRegistered = "This NPC type is not registered. Please select a valid NPC type.",
    soundDownload = "[Sound Download] ",
    assetDownloadLabel = "[Asset Download] ",
    assetSummaryImagesCompleted = "Images: %d/%d completed (%d failed)",
    assetSummarySoundsCompleted = "Sounds: %d/%d completed (%d failed)",
    ...
    resetVendorCooldownsTargetDesc = "The player to reset cooldowns for",
    npcConfigAppearanceName = "Appearance",
    npcConfigAppearanceDesc = "Rename NPCs and adjust their models, skins, bodygroups, and animations.",
    npc = "NPC",
    dialogTutorialGuideName = "Tutorial Guide",
    dialogTutorialGuideGreeting = "Hello there! I'm here to help new players learn the ropes. What would you like to know?",
    dialogTutorialOptionNewHere = "I'm new here, can you help me?",
    dialogTutorialOptionTellFactions = "Tell me about factions",
    dialogTutorialResponseTellFactions = "Factions are the main groups in this roleplay world. Every character belongs to one!",
    dialogTutorialOptionWhatFactionsAvailable = "What factions are available?",
    dialogTutorialResponseWhatFactionsAvailable = "Citizens are usually the default - regular people living their lives. There might be police, medical, or other specialized factions.",
    dialogTutorialOptionJoinFaction = "How do I join a faction?",
    dialogTutorialResponseJoinFaction = "Open your character menu (usually F1) and select 'Create Character'. Choose your faction from the dropdown menu.",
    dialogTutorialOptionFactionLimits = "Are there faction limits?",
    dialogTutorialResponseFactionLimits = "Some factions have player limits to maintain balance. Popular factions like police might be restricted.",
    dialogTutorialOptionFactionVsClass = "What's the difference between factions and classes?",
    dialogTutorialResponseFactionVsClass = "Factions are broad groups (like 'Police Department'), while classes are specialized roles within factions (like 'Detective' or 'SWAT').",
    dialogTutorialOptionMoreClasses = "Tell me more about classes",
    dialogTutorialResponseMoreClasses = "Classes give you special equipment, abilities, or restrictions. For example, a SWAT class might have better armor and weapons but move slower.",
    dialogTutorialOptionMultipleClasses = "Can I have multiple classes?",
    dialogTutorialResponseMultipleClasses = "Usually one class per character, but you can have multiple characters with different classes!",
    dialogTutorialOptionGetStartedItems = "How do I get started with items?",
    dialogTutorialResponseGetStartedItems = "Items are crucial! They include weapons, tools, food, and more.",
    dialogTutorialOptionOpenInventory = "How do I open my inventory?",
    dialogTutorialResponseOpenInventory = "Press F2 or the inventory key to open your inventory. You can drag items, equip them, or use them from there.",
    dialogTutorialOptionBuyItems = "Where can I buy items?",
    dialogTutorialResponseBuyItems = "Look for vendors (NPCs with shopping carts above their heads) or business owners. Some factions give starting items.",
    liaAmmoBoxName = "Ammo Box",
    liaAmmoBoxDesc = "Refills your active weapon",
    liaAmmoBoxInvalidWeapon = "Hold a weapon that uses primary ammo.",
    liaAmmoBoxFull = "You are already full on that ammo type.",
    liaAmmoBoxItemName = "Ammo Box Crate",
    liaAmmoBoxItemDesc = "A placeable ammo box that refills the weapon you are holding.",
    dialogTutorialOptionMoneyWork = "How does money work?",
    dialogTutorialResponseMoneyWork = "You earn money through jobs, selling items, or roleplaying. Use /givemoney to give money to others, or drop it as an item.",
    dialogTutorialOptionTradeItems = "Can I trade items?",
    dialogTutorialResponseTradeItems = "Yes! Drag items from your inventory to another player's inventory when they're nearby, or use the trade system if available.",
    dialogTutorialOptionRoleplaying = "What about roleplaying?",
    dialogTutorialResponseRoleplaying = "Roleplaying is the heart of this server! Stay in character, follow server rules, and have fun.",
    dialogTutorialOptionTalkInCharacter = "How do I talk in character?",
    dialogTutorialResponseTalkInCharacter = "Use /say or just type normally for local chat. /yell for shouting, /whisper for quiet talking, /me for actions, /it for environmental descriptions.",
    dialogTutorialOptionBasicRules = "What are the basic rules?",
    dialogTutorialResponseBasicRules = "No random deathmatching, respect other players' roleplay, follow faction rules, and don't metagame (using OOC info in IC situations).",
    dialogTutorialOptionMetagaming = "What is metagaming?",
    dialogTutorialResponseMetagaming = "Metagaming is using out-of-character knowledge in roleplay. For example, knowing someone's identity from their Steam name.",
    ...
    dialogTutorialOptionSpecificHelp = "I need help with something specific",
    ...
    dialogTutorialOptionChangeCharacter = "How do I change my character?",
    dialogTutorialResponseChangeCharacter = "Press F1 to open the character menu, then select 'Load Character' to switch between your characters.",
    dialogTutorialOptionLostItems = "I lost my items",
    dialogTutorialResponseLostItems = "Items save automatically. If you lost them due to a bug, contact an admin immediately with details about what you had.",
    dialogTutorialOptionAdminHelp = "How do I get admin help?",
    dialogTutorialResponseAdminHelp = "Use @ message or /admin command to contact admins. Be patient - they help when available!",
    ...
    copyBodygroupsByName = "Copy Bodygroups (Name)",
    copyBodygroupsByID = "Copy Bodygroups (ID)",
    copySkinClipboard = "Copy Skin to Clipboard",
}
