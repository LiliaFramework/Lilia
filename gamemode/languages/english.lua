...
LANGUAGE = {
    ...
    ammoItemDesc = "Ammunition for firearms",
    ...
    adminStickSpectateName = "Spectate",
...
Reload: Drop]],
    ...
    allAssetsDownloadedSuccess = "All assets downloaded successfully!",
    ...
    storage = "Storage",
    vendors = "Vendors",
    administrationDesc = "Provides comprehensive administration tools and staff management features.",
    attributesDesc = "Implements character attributes and provides tools for managing them.",
    chatboxDesc = "Replaces the default chat with a configurable box that supports colored text, command parsing, and dedicated staff channels.",
    doorsDesc = "Manages door ownership, access control, and door-related permissions.",
    f1menuDesc = "Provides the main F1 menu interface for players.",
    inventoryDesc = "Implements a modular grid-based inventory with item stacking, weight limits, and support for hot-loading additional modules.",
    mainmenuDesc = "Creates the in-game main menu used for selecting, creating, and managing player characters before entering the world.",
    protectionDesc = "Provides anti-cheat and anti-exploit protections.",
    recognitionDesc = "Introduces a recognition system where characters must learn each other's names and can automatically recognize members of the same faction.",
    scoreboardDesc = "Displays an immersive scoreboard showing recognized players, faction information, and built-in admin options for staff.",
    spawnsDesc = "Manages player spawns and spawn protection systems.",
    teamsDesc = "Manages teams and factions with whitelist support and admin controls.",
    adminStickDesc = "Adds the Admin Stick tool, allowing staff to quickly perform common moderation actions on players and entities with a single click.",
    itemSpawnerDesc = "Offers an in-game item spawner interface so administrators can quickly create items for testing, events, or moderation purposes.",
    loggingDesc = "Tracks administrative actions and server events, writing detailed logs that staff can review for oversight and auditing.",
    permissionsDesc = "Provides fine-grained permission management for commands and modules across the framework.",
    ticketsDesc = "Introduces a ticket system where players can submit help requests that staff can view, respond to, and resolve in an organized manner.",
    warnsDesc = "Adds a warning system complete with logs and a management menu so staff can issue, track, and remove player warnings.",
    storageDesc = "Adds persistent storage containers and player vaults that integrate with the inventory for item management.",
    vendorsDesc = "Provides NPC vendors who can buy and sell items with stock management and dialogue-driven transactions.",
    ...
    accessToolPrivilege = "Access Tool %s %s",
    ...
    npcWeaponWarning = "WARNING! Not all NPCs can use weapons and not all weapons are usable by NPCs. This is entirely dependent on the addon the weapon and the NPC are from. This mod cannot change that.",
    ...
    themeDesc = "Select a color theme for the interface.",
    ...
    uiBlurEnabled = "UI Blur Effects",
    uiBlurEnabledDesc = "Enable or disable blur effects on UI panels with alpha backgrounds.",
    uiDepthEnabled = "UI Depth Effects",
    uiDepthEnabledDesc = "Enable or disable depth-based shadow effects for UI elements.",
    language = "Language",
    ...
    hotreloadSuccess = "Gamemode hotreloaded successfully!",
    shaderLoadFailed = "Failed to load shaders!",
    demoTabContent = "Tab 1 Content",
    demoTabInput = "Tab 2 Input",
    demoButton = "liaButton",
    demoLabel = "liaText",
    demoTextEntry = "liaEntry",
    optionFunctionFailed = "Warning: Option options function for '%s' failed or returned invalid result",
    ...
    serverPasswordDisplay = "Server password: %s",
    serverPasswordSent = "Server password sent to you.",
    passwordsDoNotMatch = "Passwords do not match.",
    needMorePlaytimeToPunch = "You need more playtime before you can punch.",
    invalidCharacter = "Invalid character.",
    notEnoughStaminaToPunch = "You don't have enough stamina to punch.",
    testNotificationError = "This is an error notification",
    testNotificationSuccess = "This is a success notification",
    testNotificationWarning = "This is a warning notification",
    testNotificationInfo = "This is an info notification",
    testNotificationMoney = "This is a money notification",
    testNotificationAdmin = "This is an admin notification",
    invalidEntity = "Invalid entity",
    storageServerOnly = "Storage initialization only available on server",
    unloadedUnusedCharacters = "Unloaded %s unused characters for %s",
    ...
    indexOfTotal = "%s/%s",
    valueOfMax = "%s/%s",
    moveItemsBack = "Move Items Back %s",
    totalCount = "Total: %s",
    ...
    copyColumn = "Copy %s",
    copyAll = "Copy All",
    distanceMeasureTool = "Distance Measure Tool",
    distanceMeasurePurpose = "Measure distance between two points",
    storageContainer = "Storage Container",
    menuOption = "Menu Option %s",
    openContextMenu = "Open Context Menu",
    liaTextExample = "This is liaText panel with some example text to show how it looks.",
    openColorPicker = "Open Color Picker",
    itemNumber = "Item %s",
    openRadialMenu = "Open Radial Menu",
    radialOption = "Option %s",
    openPlayerSelector = "Open Player Selector",
    dCollapsibleCategory = "Collapsible Category",
    dNumSlider = "Number Slider",
    liaButton = "Lilia Button",
    ...
    snapshotUsage = "Usage: lia_snapshot <table_name>",
    snapshotCreating = "Creating snapshot for table: %s",
    snapshotCreatedSuccess = "Snapshot created successfully!",
    snapshotFileInfo = "File: %s",
    snapshotRecordsInfo = "Records: %s",
    snapshotPathInfo = "Path: %s",
    snapshotFailed = "Snapshot failed: %s",
    snapshotLoadUsage = "Usage: lia_snapshot_load <filename>",
    snapshotLoadAvailable = "Available snapshots:",
    snapshotLoadNotFound = "  No snapshots found",
    snapshotLoading = "Loading snapshot: %s",
    snapshotLoadedSuccess = "Snapshot loaded successfully!",
    snapshotTableInfo = "Table: %s",
    snapshotOriginalTimestamp = "Original timestamp: %s",
    snapshotLoadFailed = "Snapshot load failed: %s",
    startedRedownloadingWebImages = "Started re-downloading stored web images...",
    startedRedownloadingWebSounds = "Started re-downloading stored sounds...",
    unknownEntity = "Unknown Entity",
    unknownPlayer = "Unknown Player",
    characterDataWiped = "Character data wiped...",
    inventoryDataWiped = "Inventory data wiped...",
    characterItemsWiped = "Character items wiped...",
    charactersWiped = "All characters and related data have been wiped!",
    characterInventoriesWiped = "Character inventories wiped...",
    notificationDemoCompleted = "Notification demonstration completed!",
    startingAssetRedownload = "Starting asset redownload for all connected players...",
    assetRedownloadInitiated = "Asset redownload initiated for %s player(s). Check client consoles for progress.",
    noPlayersForRedownload = "No players connected to redownload assets for.",
    testingNotificationMethods = "Testing existing notification methods...",
    playerPositionInfo = "Player %s position: %s",
    playerAnglesInfo = "Player %s angles: %s",
    wipedTablesInfo = "Wiped tables: %s",
    ...
    nullValue = "NULL",
    staffPrefix = "Staff - %s",
    staffCharacterInfo = "A Staff Character, Discord: %s, SteamID: %s",
    failedToCreateStaffCharacter = "Failed to create staff character",
    failedToGetTableInfo = "Failed to get table info",
    cannotRemoveLastColumn = "Cannot remove the last column from table",
    tableDoesNotExist = "Table %s does not exist",
    failedToQueryTable = "Failed to query table %s",
    snapshotFileNotFound = "Snapshot file %s not found",
    failedToReadSnapshotFile = "Failed to read snapshot file",
    failedToParseJSONData = "Failed to parse JSON data: %s",
    invalidSnapshotFormat = "Invalid snapshot format",
    targetTableDoesNotExist = "Target table %s does not exist",
    failedToInsertBatch = "Failed to insert batch %s: %s",
    failedToClearTable = "Failed to clear table: %s",
    cannotGetMaterialOfShadowedRectangle = "You can't get the material of a shadowed or blurred rectangle!",
    ...
    demoNotificationDefault = "This is a default notification. It is being used to demonstrate the default notification type in the Lilia framework. The message is intentionally made longer to test the notification panel's ability to handle extended text and to ensure that the notification wraps and displays correctly for all users.",
    demoNotificationInfo = "This is an info notification. Information notifications are typically used to provide users with helpful tips, updates, or general information about the current state of the game or server. This message is longer to test the notification system's handling of verbose informational content.",
    demoNotificationError = "This is an error notification. An error has occurred in the system, and this notification is being used to alert you to the issue. Please review the error details and take any necessary corrective action. This message is intentionally verbose to test the notification display.",
    demoNotificationSuccess = "This is a success notification. Your recent action was completed successfully, and everything went as expected. This longer message is used to ensure that success notifications can accommodate more detailed feedback for the user.",
    demoNotificationWarning = "This is a warning notification. Please be aware that something may require your attention or caution. This message is extended to test how the notification system handles warnings that contain more context or instructions for the player.",
    demoNotificationMoney = "This is a money notification. You have received or lost some in-game currency. This message is intentionally longer to verify that monetary notifications can display detailed transaction information or explanations as needed.",
    demoNotificationAdmin = "This is an admin notification. Administrative actions or messages are being communicated to you. This longer message is used to test the notification system's ability to display extended admin-related information or instructions.",
    category = "Category",
    menu = "Menu",
    btn_default = "Default",
    color_cancel = "Cancel",
    color_select = "Select",
    frame_title = "Window",
    frame_alpha = "Transparent Background",
    frame_move_from_menu = "Allow Movement",
    frame_close_window = "Close Window",
    table_wrong_args = "Wrong number of arguments for table",
    table_copy = "Copy",
    table_delete_row = "Delete Row",
    player_title = "Player Selection",
    player_offline = "Offline",
    player_ping = "ms",
    player_close = "Close",
    apply = "Apply",
    combobox_select = "Select...",
    radial_select_option = "Select option",
    discord = "Discord",
    workshop = "Workshop",
    refresh = "Refresh",
    invalidFileFormat = "Invalid file format - not PNG or JPEG",
    factionGroup = "Faction Group",
    gaveItemToTarget = "Gave %s x%s to %s",
    serverPasswordDesc = "Get the current server password and copy it to your clipboard.",
    commonRarity = "Common",
    classDoesNotExist = "Class %s does not exist.",
    assetDownloadImageFailed = "Failed to download: %s (%s)",
    assetDownloadSoundFailed = "Failed to download: %s (%s)",
    assetDownloadImagePrefix = "[Image Download]",
    assetDownloadSoundPrefix = "[Sound Download]",
    assetDownloadPrefix = "[Asset Download]",
    assetDownloadWarningConsole = "WARNING: Some assets failed to download. Check console output above for details.",
    assetDownloadProgress = "Download progress: %d active, %d queued, %d/%d images, %d/%d sounds",
    assetDownloadImageSuccess = "[?] Image downloaded: %s",
    downloadSummary = "Download Summary",
    downloadCompletedFormat = "%s: %d/%d completed (%d failed)",
    assetDownloadStartHeader = "=== STARTING CLIENT-SIDE ASSET DOWNLOAD ===",
    assetDownloadWebImagesCount = "WebImages to download: %d",
    assetDownloadWebSoundsCount = "WebSounds to download: %d",
    assetDownloadQueueSize = "Download queue size: %d",
    assetDownloadProcessingMax = "Processing with max concurrent downloads: %d",
    assetDownloadCompleteHeader = "=== CLIENT-SIDE ASSETS DOWNLOAD COMPLETE ===",
    assetDownloadCurrentStats = "Current Statistics",
    assetDownloadStatsImagesFormat = "Images: %d downloaded | %d stored",
    assetDownloadStatsSoundsFormat = "Sounds: %d downloaded | %d stored",
    assetDownloadStatsCombinedFormat = "Combined: %d downloaded | %d stored",
    assetDownloadCompleteSeparator = "===========================================",
    keybindTestMessage = "Test keybind message",
    vendorWarningSkippingItem = "[Vendor] Warning: Skipping invalid item '%s' when applying preset '%s' to vendor.",
    commandPlayerOnly = "This command can only be used by players.",
    websoundInvalidFile = "[WebSound] ? Invalid: %s - %s",
    websoundCouldNotRead = "[WebSound] ? Could not read: %s",
    websoundValidationComplete = "[WebSound] Validation complete: %d valid, %d invalid",
    websoundRemovedCorruptedFile = "[WebSound] Removed corrupted file: %s (%s)",
    webimageRemovedCorruptedFile = "[WebImage] Removed corrupted file: %s",
    websoundRemovedUnreadableFile = "[WebSound] Removed unreadable file: %s",
    webimageRemovedUnreadableFile = "[WebImage] Removed unreadable file: %s",
    webimageRemovedFromCache = "[WebImage] Removed from cache: %s",
    webimageCleanupComplete = "[WebImage] Cleanup complete: %d files removed",
    websoundRemovedFromCache = "[WebSound] Removed from cache: %s",
    websoundCleanupComplete = "[WebSound] Cleanup complete: %d files removed",
    websoundFileListEntry = "[WebSound] %s (%d bytes)",
    discordRelayHTTPFailed = "[Discord Relay] HTTP failed: %s",
    itemDebugInfo = "%s[%s]: >> [%s](%s,%s)",
    itemDebugInfoSimple = "%s[%s]",
    vendorWarningCannotSetStock = "[Vendor] Warning: Cannot set stock for non-existent item '%s'",
    vendorWarningCannotAddStock = "[Vendor] Warning: Cannot add stock for non-existent item '%s'",
    vendorWarningCannotTakeStock = "[Vendor] Warning: Cannot take stock for non-existent item '%s'",
    vendorWarningCannotSetTradeMode = "[Vendor] Warning: Cannot set trade mode for non-existent item '%s'",
    vendorWarningCannotSetPrice = "[Vendor] Warning: Cannot set price for non-existent item '%s'",
    vendorWarningCannotSetMaxStock = "[Vendor] Warning: Cannot set max stock for non-existent item '%s'",
    warningLogIssued = "[WARNING ISSUED] Admin: %s (%s) | Target: %s (%s) | Reason: %s | Total Warnings: %d",
    warningLogRemoved = "[WARNING REMOVED] Admin: %s (%s) | Target: %s (%s) | Original Admin: %s (%s) | Reason: %s | Index: %d",
    vendorWarningSkippingItem = "[Vendor] Warning: Skipping invalid item '%s' when applying preset '%s' to vendor.",
    assetDownloadImageFailedConsole = "[?] Image failed: %s - %s",
    assetDownloadSoundFailedConsole = "[?] Sound failed: %s - %s",
    assetDownloadSoundSuccessConsole = "[?] Sound downloaded: %s",
    failedSetAnglesEntity = "Failed to SetAngles for entity '%s' at %s. Angle: %s (%s) - %s",
    invalidAngleForEntity = "Invalid angle for entity '%s' at %s: %s (%s)",
    receivedUnregisteredNetMessage = "Received unregistered net message: %s",
    errorInNetMessageCallback = "Error in net message callback '%s': %s",
    keybindReleaseError = "Keybind release error for %s: %s",
    keybindPressError = "Keybind press error for %s: %s",
    selectedColor = "Selected color: %s",
    optionSelected = "Option %d selected",
    selectedPlayer = "Selected player: %s",
    advancedWarningLog = "Advanced Warning Log:",
    advancedWarningRemovalLog = "Advanced Warning Removal Log:",
    invalidKeybindCallbackFormat = "lia.keybind.add: Invalid callback format in lia.keybind.add of function '%s'. Must use table with 'onPress' function. (Function: lia.keybind.add)",
    hasPrivilegeExpectedString = "hasPrivilege expected a string, got %s",
    hasAccessExpectedString = "hasAccess expected a string privilege, got %s",
    privilegeRegistrationRequiresID = "Privilege registration requires an ID field",
    failedUpdateCharacterFaction = "Failed to update character faction: %s",
    failedQueryCharacterFaction = "Failed to query character faction: %s",
    configNotFoundInStored = "Config with key '%s' not found in stored configs",
    configMissingFromStored = "Config with key '%s' is missing from stored configs",
    configOptionsFunctionFailed = "Warning: Config options function for '%s' failed or returned invalid result",
    failedLoadDoorData = "Failed to load door data: %s",
    failedSaveDoorData = "Failed to save door data: %s",
    failedGetDoorTableInfo = "Failed to get table info for lia_doors",
    failedFixCorruptedDoorData = "Failed to fix corrupted data for door %s: %s",
    failedCheckCorruptedDoorData = "Failed to check for corrupted door data: %s",
    failedDeserializeDoorFactions = "Failed to deserialize factions for door %s: %s",
    failedDeserializeDoorClasses = "Failed to deserialize classes for door %s: %s",
    failedParseDoorFactionsJSON = "Failed to parse factions JSON for door %s, using empty table",
    failedParseDoorClassesJSON = "Failed to parse classes JSON for door %s, using empty table",
    missingExpectedDoorColumn = "Missing expected column: %s",
    doorDatabaseConnectionIssue = "This may indicate a database connection issue or missing table",
    doorDatabaseSchemaProblem = "This may indicate a database connection issue or schema problem",
    foundAndFixedCorruptedDoorRecords = "Found and fixed %s corrupted door records",
    fixedCorruptedDoorData = "Fixed corrupted data for door %s",
    dataCorruptionClearingClasses = "This suggests data corruption. Clearing classes data.",
    dataCorruptionClearingFactions = "This suggests data corruption. Clearing factions data.",
    staffCharacterDiscord = "A Staff Character, Discord: ",
    canSeeAltingNotifications = "Can See Alting Notifications",
    viewEntityTab = "View Entity Tab",
    teleportToEntity = "Teleport to Entity",
