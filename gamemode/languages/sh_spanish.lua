...
LANGUAGE = {
    ...
    cloud_no_module = "El module provisto no es válido.",
    inv = "Inventario",
    modules = "Modules",
    author = "Autor",
    version = "Versión",
    ...
    contentTitle = "Content del Lilia Ausent",
    contentWarning = "No tienes el contenido de Lilia montado. Esto puede probocar ciertas fallas en las funciones.\nUtilice el contenido de Lilia de Rebel1324.\n¿Le gustaría abrir la página del Workshop para el contenido de Lilia?",
    flags = "Flags",
