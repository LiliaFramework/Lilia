...
LANGUAGE = {
    ...
    contentTitle = "Lilia Innhold Mangler",
    contentWarning = "Du har ikke Lilia innhold montert. Dette kan føre til enkelte funksjoner mangler. \nVil du åpne Workshop side for Lilia innhold?",
    flags = "Flagg"
}