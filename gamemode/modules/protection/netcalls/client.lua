...
lia.net.readBigTable("liaEntityTabData", function(payload)
    ...
    lia.debug("[Entity Tab Debug]", "receivedServerPayload=true", "owners=", tostring(istable(MODULE.entityTabData.owners) and #MODULE.entityTabData.owners or 0), "totalEntities=", tostring(MODULE.entityTabData.totalEntities or 0))
