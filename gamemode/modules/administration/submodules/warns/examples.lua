hook.Add("WarningIssued", "ExampleWarningIssued", function(admin, target, reason, count, adminSteamID, targetSteamID) print(L("warningLogIssued", admin:Name(), adminSteamID, target:Name(), targetSteamID, reason, count)) end)
hook.Add("WarningRemoved", "ExampleWarningRemoved", function(admin, target, warning, index) print(L("warningLogRemoved", admin:Name(), admin:SteamID(), target:Name(), warning.targetSteamID, warning.admin, warning.adminSteamID, warning.reason, index)) end)
