function GM:LoadLiliaFonts(font, genericFont)
    ...
    surface.CreateFont("lia3D2DMediumFont", {
        font = font,
        size = 48,
        extended = true,
        weight = 100
    ...
    surface.CreateFont("lia3D2DSmallFont", {
        font = font,
        size = 24,
        extended = true,
        weight = 400
    ...
    surface.CreateFont("liaMenuMiniFont", {
        font = "Roboto",
    ...
    surface.CreateFont("liaMenuButtonFontSmall", {
        font = "Roboto Th",
        size = ScreenScale(10),
        extended = true,
        weight = 100
    ...
    surface.CreateFont("liaMenuButtonFontThick", {
        font = "Roboto",
        size = ScreenScale(14),
        extended = true,
        weight = 300
    ...
    surface.CreateFont("liaMenuButtonLabelFont", {
        font = "Roboto Th",
        size = 28,
        extended = true,
        weight = 100
    ...
    surface.CreateFont("liaMenuButtonHugeFont", {
        font = "Roboto Th",
        size = ScreenScale(24),
        extended = true,
        weight = 100
    ...
    surface.CreateFont("liaMonoSmallFont", {
        font = "Consolas",
        size = 12,
        extended = true,
        weight = 800
    ...
    surface.CreateFont("liaMonoMediumFont", {
        font = "Consolas",
        size = 22,
        extended = true,
        weight = 800
    ...
    surface.CreateFont("liaMediumLightBlurFont", {
        font = font,
        size = 25,
        extended = true,
        weight = 200,
    ...
    surface.CreateFont("liaSmallTitleFont", {
        font = "Roboto Th",
    ...
    surface.CreateFont("liaMinimalTitleFont", {
        font = "Roboto",
    ...
    surface.CreateFont("liaIntroTitleBlurFont", {
        font = font,
        size = math.min(ScreenScale(128), 128),
        extended = true,
        weight = 100,
    ...
    surface.CreateFont("liaIntroSubtitleFont", {
        font = font,
        size = ScreenScale(24),
        extended = true,
        weight = 100
    ...
    surface.CreateFont("liaSmallTitleIcons", {
        font = "fontello",
    ...
    surface.CreateFont("liaIconsMenuButton", {
        font = "fontello",
        size = ScreenScale(14),
        extended = true,
        weight = 100
