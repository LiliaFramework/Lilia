...
<div id="outfit-generator">
    <div class="generator-section">
        ...
        <div class="input-group">
            ...
            <textarea id="item-desc" placeholder="e.g., Standard police officer uniform with body armor"></textarea>
        </div>

        <div class="input-group">
            <label for="item-category">Category:</label>
            <input type="text" id="item-category" placeholder="clothing" value="clothing">
    ...
    <div class="generator-section">
        ...
        <div class="input-group">
            ...
            <input type="text" id="item-model" placeholder="models/player/police.mdl">
            <small>3D model path for the outfit item</small>
        </div>

        <div class="input-group">
            <label for="item-width">Width:</label>
            <input type="number" id="item-width" placeholder="2" min="1" value="2">
            <small>Inventory slot width</small>
        </div>

        <div class="input-group">
            <label for="item-height">Height:</label>
            <input type="number" id="item-height" placeholder="2" min="1" value="2">
            <small>Inventory slot height</small>
        </div>
    </div>

    <div class="generator-section">
        <h3>Outfit Properties</h3>
        <div class="input-group">
            <label for="outfit-category">Outfit Category:</label>
            <input type="text" id="outfit-category" placeholder="police">
            <small>Category for outfit organization and replacement logic</small>
        </div>

        <div class="input-group">
            <label>
                <input type="checkbox" id="replace-bodygroups"> Replace Bodygroups
            </label>
            <small>Replace existing bodygroups instead of adding to them</small>
        </div>

        <div class="input-group">
            <label for="pac-data">PAC3 Data:</label>
            <textarea id="pac-data" placeholder='{"groups": {"hands": "models/police_hands.mdl"}}' rows="3"></textarea>
            <small>JSON format PAC3 outfit data (optional)</small>
        </div>
    </div>
...
```lua
-- Generated outfit item code will appear here after clicking "Generate Outfit Item Code"
```
