...
Interactive tool for generating Lilia grenade item definitions. Fill out the fields below and click "Generate Grenade Item Code" to create your item code.
