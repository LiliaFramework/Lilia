...
<summary><span class="summary-main"><a id="lia.admin.getUsergroupIcon"></a>lia.admin.getUsergroupIcon(groupOrPlayer)</span><a class="source-link-button source-link-button--summary" href="https://github.com/LiliaFramework/Lilia/blob/main/gamemode/core/libraries/admin.lua#L253" target="_blank" rel="noopener noreferrer" onclick="event.stopPropagation()">View Source</a></summary>
<div class="details-content">
...
<summary><span class="summary-main"><a id="lia.admin.applyInheritance"></a>lia.admin.applyInheritance(groupName)</span><a class="source-link-button source-link-button--summary" href="https://github.com/LiliaFramework/Lilia/blob/main/gamemode/core/libraries/admin.lua#L1602" target="_blank" rel="noopener noreferrer" onclick="event.stopPropagation()">View Source</a></summary>
<div class="details-content">
