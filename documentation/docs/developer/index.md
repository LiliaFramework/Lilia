...
<div class="card-grid">
  ...
  <a href="./libraries/" class="card">
    ...
    <h3>Libraries</h3>
    <p>Find shared helper libraries for things like money, items, characters, and framework tools.</p>
  </a>
  <a href="./meta/" class="card">
    <span class="card-kicker">Core objects</span>
    <h3>Meta Tables</h3>
    <p>Read what Character, Player, Entity, Item, Inventory, and Panel objects can do.</p>
  </a>
</div>
