...
netstream.Hook(
    ...
    function()
        ...
        menu:AddOption(
            ...
            function()
                RecognitionCore:CharRecognize(2)
            end
        )
        ...
        menu:AddOption(
            ...
            function()
                RecognitionCore:CharRecognize(3)
            end
        )
        ...
        menu:AddOption(
            ...
            function()
                RecognitionCore:CharRecognize(4)
            end
        )
            ...
            menu:AddOption(
                ...
                function()
                    Derma_StringRequest(
                        ...
                        function(text)
                            if text then
                                RecognitionCore:CharRecognize(2, text)
                            end
                        end
                    )
                end
            ...
            menu:AddOption(
                ...
                function()
                    Derma_StringRequest(
                        ...
                        function(text)
                            if text then
                                RecognitionCore:CharRecognize(3, text)
                            end
                        end
                    )
                end
            ...
            menu:AddOption(
                ...
                function()
                    Derma_StringRequest(
                        ...
                        function(text)
                            if text then
                                RecognitionCore:CharRecognize(4, text)
                            end
                        end
                    )
                end
