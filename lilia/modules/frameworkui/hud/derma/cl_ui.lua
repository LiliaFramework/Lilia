...
function String_Request(question, ok, _, numeric)
    ...
    Empty_Popup(
        function(frame)
            ...
            wp.done:SetFont("FrameworkHUD_Small")
...
function Important_Notification(message)
    Empty_Popup(
        function(frame)
            ...
            g.msg:SetFont("FrameworkHUD_Medium")
            g.msg:SetTextColor(color_white)
            g.msg:SizeToContents()
            g.msg:Center()
            g.cont = wp:Add("FrameworkHUDutton")
