...
function PANEL:Init()
    ...
    if MODULE.InfoMenuLocation == "TopLeft" then
        self:SetPos(10, 10)
    elseif MODULE.InfoMenuLocation == "TopRight" then
        self:SetPos(ScrW() - panelWidth - 10, 10)
    elseif MODULE.InfoMenuLocation == "BottomLeft" then
        self:SetPos(10, ScrH() - panelHeight - 10)
    elseif MODULE.InfoMenuLocation == "BottomRight" then
