...
function MODULE:CanTool(client, _, tool)
    ...
    if IsValid(entity) then
        ...
        if (tool == "permaall" or tool == "permaprops" or tool == "blacklistandremove") and (string.StartsWith(entClass, "lia_") or table.HasValue(self.CanNotPermaProp, entClass) or self:IsPersistent() or entity:CreatedByMap()) then return false end
