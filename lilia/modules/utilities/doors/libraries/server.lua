...
lia.log.addType("doorSetClass", function(client, door, className) return L("doorLogSetClass", client:SteamID(), client:Name(), className, door:GetClass()) end, "Doors")
lia.log.addType("doorRemoveClass", function(client, door) return L("doorLogRemoveClass", client:SteamID(), client:Name(), door:GetClass()) end, "Doors")
lia.log.addType("doorSaveData", function(client) return L("doorLogSaveData", client:SteamID(), client:Name()) end, "Doors")
lia.log.addType("doorToggleOwnable", function(client, door, state) return L("doorLogToggleOwnable", client:SteamID(), client:Name(), door:GetClass(), state and "unownable" or "ownable") end, "Doors")
lia.log.addType("doorSetFaction", function(client, door, factionName) return L("doorLogSetFaction", client:SteamID(), client:Name(), factionName, door:GetClass()) end, "Doors")
lia.log.addType("doorRemoveFaction", function(client, door, factionName) return L("doorLogRemoveFaction", client:SteamID(), client:Name(), factionName, door:GetClass()) end, "Doors")
lia.log.addType("doorSetHidden", function(client, door, state) return L("doorLogSetHidden", client:SteamID(), client:Name(), door:GetClass(), state and "hidden" or "visible") end, "Doors")
lia.log.addType("doorSetTitle", function(client, door, title) return L("doorLogSetTitle", client:SteamID(), client:Name(), title, door:GetClass()) end, "Doors")
lia.log.addType("doorResetData", function(client, door) return L("doorLogResetData", client:SteamID(), client:Name(), door:GetClass()) end, "Doors")
lia.log.addType("doorSetParent", function(client, door) return L("doorLogSetParent", client:SteamID(), client:Name(), door:GetClass()) end, "Doors")
lia.log.addType("doorAddChild", function(client, parentDoor, childDoor) return L("doorLogAddChild", client:SteamID(), client:Name(), childDoor:GetClass(), parentDoor:GetClass()) end, "Doors")
lia.log.addType("doorRemoveChild", function(client, parentDoor, childDoor) return L("doorLogRemoveChild", client:SteamID(), client:Name(), childDoor:GetClass(), parentDoor:GetClass()) end, "Doors")
lia.log.addType("doorForceLock", function(client, door) return L("doorLogForceLock", client:SteamID(), client:Name(), door:GetClass()) end, "Doors")
lia.log.addType("doorForceUnlock", function(client, door) return L("doorLogForceUnlock", client:SteamID(), client:Name(), door:GetClass()) end, "Doors")
lia.log.addType("doorDisable", function(client, door) return L("doorLogDisable", client:SteamID(), client:Name(), door:GetClass()) end, "Doors")
lia.log.addType("doorEnable", function(client, door) return L("doorLogEnable", client:SteamID(), client:Name(), door:GetClass()) end, "Doors")
lia.log.addType("doorDisableAll", function(client, count) return L("doorLogDisableAll", client:SteamID(), client:Name(), count) end, "Doors")
lia.log.addType("doorEnableAll", function(client, count) return L("doorLogEnableAll", client:SteamID(), client:Name(), count) end, "Doors")