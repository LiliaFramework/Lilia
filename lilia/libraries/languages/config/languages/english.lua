...
LANGUAGE = {
    ...
    cloud_no_module = "The module provided is not valid.",
    inv = "Inventory",
    modules = "Modules",
    author = "Author",
    version = "Version",
    ...
    ziptied = "You have been restrained.",
    ...
    contentTitle = "Lilia Content Missing",
    contentWarning = "You do not have the Lilia content mounted. This may result in certain features missing.\nLilia Content's address have been changed to rebel1324's one.\nWould you like to open the Workshop page for the Lilia content?",
    flags = "Flags",
    ...
    ammoLoadCustom = "Load...",
    split = "Split",
    splitHelp = "Enter a number to split.",
    splitHalf = "Split 1/2",
