...
function GM:TranslateActivity(client, act)
    ...
    if class == "player" then
        if (RaisedWeaponCore and not RaisedWeaponCore.WepAlwaysRaised) and IsValid(weapon) and (client.isWepRaised and not client.isWepRaised(client)) and client:OnGround() then
