...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function lia.util.soundPlayAtLocation(snd, pos, lvl, pitch, vol, client)
    if not snd or not isstring(snd) then return end
    if not pos or not isvector(pos) then return end
    if not lvl or not isnumber(lvl) then lvl = 75 end
    if not pitch or not isnumber(pitch) then pitch = 100 end
    if not vol or not isnumber(vol) then vol = 1 end
    if SERVER then
        net.Start("lilia_soundplay")
