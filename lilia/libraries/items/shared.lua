...
-- @realm shared
-- @internal
-- @param path Path of the item file
-- @param baseID Unique ID of the item's base
-- @param isBaseItem Whether the item is a base item
-- @usageStart
...
---
-- Returns whether the input is an item object or not.
--
...
-- @param isBaseItem Whether the item is a base item
-- @param path Path of the item file
-- @param luaGenerated Whether the item is generated by Lua
-- @usageStart
...
-- @realm shared
-- @param directory Directory to load items from
-- @usageStart
