...
LANGUAGE = {
    ...
    sbOptions = "Click to access scoreboard options for %s",
    sbPing = "Ping: %s",
    ...
    vendorEditorWelcomeMessage = "Edit the Default Vendor Welcome Message",
    ...
    sameOutfitCategory = "You are already wearing this kind of outfit.",
    ...
    charDeletionCannotUndone = "Deleting a character cannot be undone.",
    ...
    noSpawnsForFaction = "No spawns exist for this faction!",
    notAllowed = "You are not allowed to do this action.",
    passwordTooQuick = "Please wait before setting another password!",
    pointsLeft = "Points Left",
    spawnDeletedByName = "Deleted %s spawns for %s.",
    uiColumnUniqueID = "Unique ID",
    vendorNoDescription = "No description available for this item.",
    vendorStockCurReq = "Enter the current stock value.",
    vendorStockReq = "Enter the maximum stock value.",
