...
LANGUAGE = {
    ...
    thirdpersonClassic = "Klassische Drittperson verwenden",
    ...
    contentTitle = "Fehlender Lilia-Inhalt",
    contentWarning = "Du hast den Lilia-Inhalt nicht montiert. Dadurch können bestimmte Funktionen fehlen.\nDie Adresse des Lilia-Inhalts wurde zu rebel1324 geändert.\nMöchtest du die Workshop-Seite für den Lilia-Inhalt öffnen?",
    flags = "Flaggen",
