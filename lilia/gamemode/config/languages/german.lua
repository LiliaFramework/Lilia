...
LANGUAGE = {
    ...
    cloud_no_module = "Das angegebene Module ist ungültig.",
    inv = "Inventar",
    modules = "Modules",
    toggleModules = "Modules umschalten",
    author = "Autor",
    version = "Version",
    ...
    ziptied = "Du wurdest eingeschränkt.",
    ...
    contentTitle = "Lilia Inhalt fehlt",
    contentWarning = "Sie haben keine Lilia-Inhalte installiert. Dies kann dazu führen, dass einige Funktionen fehlen.\nMöchten Sie die Lilia-Content-Workshop-Seite öffnen?",
    flags = "Flags",
