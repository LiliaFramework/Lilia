...
LANGUAGE = {
    ...
    contentTitle = "Contenu Lilia Manquant",
    contentWarning = "Vous n'avez pas monté le contenu Lilia. Cela peut entraîner l'absence de certaines fonctionnalités.\nL'adresse du contenu Lilia a été modifiée en celle de rebel1324.\nSouhaitez-vous ouvrir la page Workshop pour le contenu Lilia ?",
    flags = "Drapeaux",
