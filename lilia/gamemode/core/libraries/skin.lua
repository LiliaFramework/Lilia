...
SKIN.fontCategoryHeader = "liaSmallFont"
...
function SKIN:PaintButton(panel, w, h)
    ...
    if panel:GetDisabled() then return self.tex.Button_Dead(0, 0, w, h) end
    if panel.Hovered then return self.tex.Button_Hovered(0, 0, w, h) end
...
function SKIN:PaintWindowCloseButton(panel, w, h)
    ...
    if panel.Depressed or panel:IsSelected() then return self.tex.Window.Close_Down(0, 0, w, h) end
    if panel.Hovered then return self.tex.Window.Close_Hover(0, 0, w, h) end
    self.tex.Window.Close(0, 0, w, h)
end

function SKIN:PaintWindowMinimizeButton(panel, w, h)
    if not panel.m_bBackground then return end
    if panel:GetDisabled() then return self.tex.Window.Mini(0, 0, w, h, Color(255, 255, 255, 50)) end
    if panel.Depressed or panel:IsSelected() then return self.tex.Window.Mini_Down(0, 0, w, h) end
    if panel.Hovered then return self.tex.Window.Mini_Hover(0, 0, w, h) end
    self.tex.Window.Mini(0, 0, w, h)
end

function SKIN:PaintWindowMaximizeButton(panel, w, h)
    if not panel.m_bBackground then return end
    if panel:GetDisabled() then return self.tex.Window.Maxi(0, 0, w, h, Color(255, 255, 255, 50)) end
    if panel.Depressed or panel:IsSelected() then return self.tex.Window.Maxi_Down(0, 0, w, h) end
    if panel.Hovered then return self.tex.Window.Maxi_Hover(0, 0, w, h) end
...
function SKIN:PaintScrollBarGrip(panel, w, h)
    ...
    if panel.Hovered then return self.tex.Scroller.ButtonV_Hover(0, 0, w, h) end
...
function SKIN:PaintComboDownArrow(panel, w, h)
    ...
    if panel.ComboBox.Hovered then return self.tex.Input.ComboBox.Button.Hover(0, 0, w, h) end
...
function SKIN:PaintComboBox(panel, w, h)
    ...
    if panel.Hovered then return self.tex.Input.ComboBox.Hover(0, 0, w, h) end
...
function SKIN:PaintNumberDown(panel, w, h)
    ...
    if panel.Hovered then return self.tex.Input.UpDown.Down.Hover(0, 0, w, h) end
...
function SKIN:PaintSliderKnob(panel, w, h)
    ...
    if panel.Depressed then return self.tex.Input.Slider.H.Down(0, 0, w, h) end
    if panel.Hovered then return self.tex.Input.Slider.H.Hover(0, 0, w, h) end
...
function SKIN:PaintCollapsibleCategory(panel, w, h)
    if not panel:GetExpanded() and h < 40 then return self.tex.CategoryList.Header(0, 0, w, h) end
