...
function GM:EntityTakeDamage(entity, dmgInfo)
    ...
    if IsValid(attacker) and attacker:GetClass() == "prop_physics" then return true end
    if IsValid(inflictor) and inflictor:GetClass() == "prop_physics" then return true end
