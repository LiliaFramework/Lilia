...
LANGUAGE = {
    ...
    cloud_no_module = "Выбранный модуль недействителен.",
    inv = "Инвентарь",
    modules = "модули",
    author = "Автор",
    version = "Версия",
    ...
    contentTitle = "Отсутствует контент Lilia",
    contentWarning = "У вас не установлен контент Lilia.\nВы желаете перейти на страницу скачивания контента?",
    Assign = "Присвоить",
    Freq = "Частота",
    Toggle = "Переключить",
    Use = "Использовать",
