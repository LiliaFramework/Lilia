...
stds = {
    lilia = {
        globals = {"lia", "SCHEMA", "ITEM", "MODULE", "g_ContextMenu", "ATTRIBUTE", "ICON_INFO", "paintedEntitiesCache", "g_VoicePanelList", "MYSQLOO_INTEGER", "MYSQLOO_STRING", "MYSQLOO_PREPARED", "MYSQLOO_BOOL", "TABLE_WAIT_ID", "MYSQLOO_QUEUE", "PREPARE_CACHE", "ModulesLoaded", "LIA_CVAR_CHATFILTER", "CURFREQ", "CURCHANNEL", "NAME", "LANGUAGE", "FACTION", "CLASS", "CHAT_RECOGNIZED", "LIA_CVAR_LANG", "ALWAYS_RAISED", "ACT_VM_FISTS_HOLSTER", "ACT_VM_FISTS_DRAW", "CARRY_WEIGHT_LIMIT", "CARRY_FORCE_LIMIT", "THROW_VELOCITY_CAP", "CARRY_STRENGTH_CHAD", "CARRY_FORCE_LEVEL", "PLAYER_PICKUP_RANGE", "CARRY_STRENGTH_GOD", "CARRY_STRENGTH_TERMINATOR", "VENDOR_WELCOME", "VENDOR_LEAVE", "VENDOR_NOTRADE", "VENDOR_PRICE", "VENDOR_STOCK", "VENDOR_MODE", "VENDOR_MAXSTOCK", "VENDOR_SELLANDBUY", "VENDOR_SELLONLY", "VENDOR_BUYONLY", "VENDOR_TEXT", "LIA_VENDORS", "lia.config.StorageDefinitions", "CARRY_STRENGTH_NERD", "ICON_RENDER_QUEUE", "USABLE_FUNCS",},
