...
function PLUGIN:CanPlayerTradeWithVendor(client, vendor, itemType, isSellingToVendor)
...
function PLUGIN:VendorTradeAttempt(client, vendor, itemType, isSellingToVendor)
