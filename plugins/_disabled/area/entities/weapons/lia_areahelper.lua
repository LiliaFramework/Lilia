...
if (SERVER) then
	...
	function SWEP:DrawHUD()
		local w, h = ScrW(), ScrH()
		local cury = h/4*3
		local tx, ty = draw.SimpleText("Left Click: Set Area Point", "liaMediumFont", w/2, cury, color_white, 1, 1)
		cury = cury + ty
		local tx, ty = draw.SimpleText("Right Click: Reset Area Point", "liaMediumFont", w/2, cury, color_white, 1, 1)
		cury = cury + ty
