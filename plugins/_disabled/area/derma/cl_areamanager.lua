...
vgui.Register("liaAreaManager", PANEL, "DFrame")

netstream.Hook("liaAreaManager", function(areaList)
	PLUGIN.areaTable = areaList
	areaManager = vgui.Create("liaAreaManager")
end)
