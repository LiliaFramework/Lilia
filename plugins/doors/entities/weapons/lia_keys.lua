...
function SWEP:PrimaryAttack()
	...
	--]]
    if IsValid(entity) and ((entity:isDoor() and (entity:checkDoorAccess(self.Owner) or (self.Owner:IsAdmin() ))) or (entity:IsVehicle() and ((entity.CPPIGetOwner and entity:CPPIGetOwner() == self.Owner) or (entity.GetCreator and entity:GetCreator() == self.Owner)))) then
