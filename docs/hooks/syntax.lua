...
@type command type
@typeCommentStart
The !@type command declares a datatype (e.g., 'function', 'method', 'table' etc.) and a name (e.g., lia.item.get(params)).
...
@string Name Required. The function or method name: lia.item.get(); Character:get().
@usageStart
...
@usageStart
!@usageStart
lia.item.register("example", "base_food", false, "example.lua", false)
!@usageEnd
@usageEnd
]]
usageStart 
