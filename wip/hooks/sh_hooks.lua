...
function GM:PhysgunPickup(client, entity)
    ...
    if client:IsAdmin() and not (entity:IsPlayer() and entity:IsSuperAdmin()) then return true end
    if self.BaseClass:PhysgunPickup(client, entity) == false then return false end
